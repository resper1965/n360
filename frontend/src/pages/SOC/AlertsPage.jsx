    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-ness-muted mt-1">Alertas do Wazuh e outros sistemas de segurança</p>
        </div>
      ...
      <div className="bg-ness-surface border border-ness-border rounded-xl overflow-hidden">
        {loading ? (
          <div className="p-12 text-center text-ness-muted">Carregando alertas...</div>
        ) : alerts.length === 0 ? (
