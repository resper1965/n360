    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-ness-surface border border-ness-border rounded-xl p-6">
          <div className="text-ness-muted text-sm mb-2">Online Applications</div>
          <div className="text-4xl font-bold text-green-500">{status?.summary?.onlineApps || 0}</div>
        </div>
        <div className="bg-ness-surface border border-ness-border rounded-xl p-6">
          <div className="text-ness-muted text-sm mb-2">Offline Applications</div>
          ...
          >
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-ness-muted">Version:</span>
                <span className="text-ness-text">{app.version || 'N/A'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-ness-muted">Last Check:</span>
